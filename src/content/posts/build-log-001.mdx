...
builds: ["command-center", "wafergraph"]
---
...
It tracks 615 companies and 3,400+ real supplier/customer links across a dozen value-chain segments, with financials, who depends on whom, market share, and where the real chokepoints are. If you've ever wanted to understand why one fab or one materials supplier can hold up the entire AI buildout, this is the map.

## Who's Starting

[Who's Starting](https://whosstarting.com) started as a mobile-first depth-chart viewer for game day and grew into a full sports app — WS Power ratings for all 135 FBS teams, Dynasty Mode (call every play, recruit, rebuild), and Draft the Country. Zero ads. Still the most "scratch my own itch" thing on this list.
